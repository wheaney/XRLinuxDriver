...
| VITURE   | Beast | :heavy_check_mark:&nbsp;XR&nbsp;driver&nbsp;v2.11.x<br/><br/>:heavy_check_mark:&nbsp;Breezy&nbsp;Desktop&nbsp;v2.11.x<br/><br/>:clock4:&nbsp;Decky&nbsp;XR&nbsp;Gaming | :+1: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://static.viture.com/dfu-util/). Requires Chrome on Windows/Mac. | Using official SDK with [custom fusion](https://github.com/wheaney/xrDeviceKit), exhibits slightly more drift and calibration time. |
| VITURE   | Pro&nbsp;2&nbsp;XR | :clock4:&nbsp;XR&nbsp;driver&nbsp;v2.11.x<br/><br/>:clock4:&nbsp;Breezy&nbsp;Desktop&nbsp;v2.11.x<br/><br/>:clock4:&nbsp;Decky&nbsp;XR&nbsp;Gaming |  |  |  |  | Present in the specified versions but requires testing/tuning |
...
| XREAL    | XBX&nbsp;A01<br/>XBX&nbsp;A01&nbsp;Plus | :heavy_check_mark:&nbsp;IMU&nbsp;head&nbsp;tracking<br/><br/>**Experimental** | :-1: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://www.xreal.com/support/update/). Requires Chrome. | Community-contributed. IMU verified on XBX A01+ hardware (~1000&nbsp;Hz). MCU bootstrap discovered by [taowen](https://github.com/taowen/ar-glass-lib). Display-mode/SBS control not yet implemented. |
