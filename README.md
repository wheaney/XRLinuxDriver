...
| VITURE   | Luma, Luma Pro | :heavy_check_mark:&nbsp;XR driver v2.1.x<br/><br/>:heavy_check_mark:&nbsp;Breezy v2.2.x<br/><br/>:heavy_check_mark:&nbsp;Decky XR Gaming v1.3.x | :+1: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://static.viture.com/dfu-util/). Requires Chrome on Windows/Mac. | Devices untested. |
| VITURE   | Luma Ultra, Beast | :clock4: Coming soon... |  |  |  |  | Support requires updates to the official SDK. |
...
| XREAL    | One, One Pro | :heavy_check_mark:&nbsp;XR&nbsp;driver&nbsp;v2.4.x<br/><br/>:heavy_check_mark:&nbsp;Breezy&nbsp;Desktop&nbsp;v2.4.x<br/><br/>:heavy_check_mark:&nbsp;Decky XR Gaming v1.3.x<br/><br/>**See notes before use** | :-1: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://www.xreal.com/support/update/). Requires Chrome. | **Important** - Disable stabilizer/anchor features on glasses. Must be on latest firmware. |
