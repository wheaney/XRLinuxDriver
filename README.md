...
| XREAL    | One, One Pro | :heavy_check_mark:&nbsp;XR&nbsp;driver&nbsp;v2.4.x<br/><br/>:heavy_check_mark:&nbsp;Breezy&nbsp;Desktop&nbsp;v2.4.x<br/><br/>**See notes** | :-1: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://www.xreal.com/support/update/). Requires Chrome. | **Important** - Disable stabilizer feature on glasses. Must be on latest firmware. |
