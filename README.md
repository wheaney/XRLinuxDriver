...
| -------- | ----------------- | -----------------   | ------------ | -------------- | --------------- | --------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| VITURE   | One,One Lite, Pro | :heavy_check_mark: | :+1: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://static.viture.com/dfu-util/). Requires Chrome on Windows/Mac. | Official collaboration. [Closed source SDK](https://www.viture.com/developer/viture-one-sdk-for-linux). |
| VITURE   | Luma, Luma Pro | :heavy_check_mark:&nbsp;XR driver v2.1.x<br/><br/>:heavy_check_mark:&nbsp;Breezy v2.2.x<br/><br/>:x:&nbsp;Decky XR Gaming v1.3.0 | :clock4: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://static.viture.com/dfu-util/). Requires Chrome on Windows/Mac. | Devices untested. |
| VITURE   | Luma Ultra, Beast | :x: |  |  |  |  | Support requires updates to the official SDK. |
...
| XREAL    | One, One Pro | :heavy_check_mark:&nbsp;XR&nbsp;driver&nbsp;v2.4.x<br/><br/>:heavy_check_mark:&nbsp;Breezy&nbsp;Desktop&nbsp;v2.4.x<br/><br/>:heavy_check_mark:&nbsp;Decky XR Gaming v1.3.0<br/><br/>**See notes before use** | :-1: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://www.xreal.com/support/update/). Requires Chrome. | **Important** - Disable stabilizer feature on glasses. Must be on latest firmware. |
