...
| XREAL    | 1S | :heavy_check_mark:&nbsp;XR&nbsp;driver&nbsp;v2.8.x<br/><br/>:heavy_check_mark:&nbsp;Breezy&nbsp;Desktop&nbsp;v2.8.x<br/><br/>:clock4: &nbsp;Decky XR Gaming v1.5.x<br/><br/>**See notes before use** | :-1: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://www.xreal.com/support/update/). Requires Chrome. | **Important** - Disable stabilizer/anchor features on glasses. Must be on latest firmware. |
