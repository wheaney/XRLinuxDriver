...
| Rokid    | Max, Air          | :heavy_check_mark: | :+1: | :heavy_check_mark:              |             |                                                       | Supported as of v0.10.7, not yet in decky. Official collaboration, closed source SDK.                                                   |
...
| XREAL    | Air 2 Ultra   | **Partially** (see notes) | :-1: | :heavy_check_mark: | :heavy_check_mark:    | same                            | Partially supported as of v0.10.6, net yet in decky. No side-by-side mode. No widescreen mode on Breezy GNOME. Same limiatations as other XREAL models above. |
