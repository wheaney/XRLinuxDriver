...
| VITURE   | Luma, Luma Pro | :heavy_check_mark:&nbsp;XR driver v2.1.x<br/><br/>:heavy_check_mark:&nbsp;Breezy v2.2.x<br/><br/>:heavy_check_mark:&nbsp;Decky XR Gaming v1.3.0 | :clock4: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://static.viture.com/dfu-util/). Requires Chrome on Windows/Mac. | Devices untested. |
