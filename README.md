...
| VITURE   | Luma, Luma Pro | :heavy_check_mark:&nbsp;XR driver v2.1.x<br/><br/>:heavy_check_mark:&nbsp;Breezy v2.2.x<br/><br/>:x:&nbsp;Decky XR Gaming (TBA) | :clock4: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://static.viture.com/dfu-util/). Requires Chrome on Windows/Mac. | Devices untested. |
...
| XREAL    | One, One Pro | :heavy_check_mark:&nbsp;XR&nbsp;driver&nbsp;v2.4.x<br/><br/>:heavy_check_mark:&nbsp;Breezy&nbsp;Desktop&nbsp;v2.4.x<br/><br/>:x:&nbsp;Decky XR Gaming (TBA)<br/><br/>**See notes before use** | :-1: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://www.xreal.com/support/update/). Requires Chrome. | **Important** - Disable stabilizer feature on glasses. Must be on latest firmware. |
