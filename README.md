...
This driver allows your Linux device (including Steam Deck) to automatically recognize supported XR glasses -- currently XREAL Air 1, 2, Pro and VITURE One -- when they're plugged in, and convert the movements of the glasses into mouse movements and an external broadcast that games or any application can utilize.
