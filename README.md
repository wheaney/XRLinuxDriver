...
| XREAL    | One, One Pro | :heavy_check_mark: Requires&nbsp;latest&nbsp;firmware. XR&nbsp;driver&nbsp;v2.3.x Breezy&nbsp;Desktop&nbsp;v2.4.x | :-1: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://www.xreal.com/support/update/). Requires Chrome. | **Important** - Disable stabilizer feature on glasses. Must be on latest firmware. |
